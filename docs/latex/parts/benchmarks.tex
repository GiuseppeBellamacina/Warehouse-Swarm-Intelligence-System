...
\begin{figure}[H]
  ...
  \subcaptionbox{1S-1C-3R --- \texttt{unknown}, no-seek\label{fig:snap-a-13r-unk-ns}}[0.48\textwidth]{%
    \includegraphics[width=0.48\textwidth]{../benchmarks/A/snapshot_1S-1C-3R_unknown__no-seek.png}}%
  \caption{Snapshot finali delle sei configurazioni testate --- Preset~A}
  \label{fig:snap-a-grid}
\end{figure}
...
\begin{figure}[H]
  ...
  \subcaptionbox{1S-1C-3R --- \texttt{unknown}, no-seek\label{fig:snap-b-13r-unk-ns}}[0.48\textwidth]{%
    \includegraphics[width=0.48\textwidth]{../benchmarks/B/snapshot_1S-1C-3R_unknown__no-seek.png}}%
  \caption{Snapshot finali delle sei configurazioni testate --- Preset~B}
  \label{fig:snap-b-grid}
\end{figure}
